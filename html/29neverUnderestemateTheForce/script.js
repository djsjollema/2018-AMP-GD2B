...
function setup(){
  ...
  n = new LinearFunction(1,1);


  earth.pos = new Vector2d(canvas.width/2,canvas.height/2);
  earth.point = new Point(earth.pos.dx,earth.pos.dy,100,"rgba(0,0,255,0.01)");
...
function animate(){
  ...
  n.defineLineWithTwoPoints(moon.point,moon1.point);
  ...
  moon1.acc.r = 10000/(distanceEarthMoon1*distanceEarthMoon1);
